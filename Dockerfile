...
RUN wget https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-ayxs93eZNN/3.2.0.LTS/ti_cgt_armllvm_3.2.0.LTS_linux-x64_installer.bin && \
    chmod +x ti_cgt_armllvm_3.2.0.LTS_linux-x64_installer.bin && \
    ./ti_cgt_armllvm_3.2.0.LTS_linux-x64_installer.bin --mode unattended --prefix . && \
    rm ti_cgt_armllvm_3.2.0.LTS_linux-x64_installer.bin
...
ENV PATH="/ti-cgt-armllvm_3.2.0.LTS/lib:${PATH}"
