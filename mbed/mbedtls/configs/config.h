...
// This piece of code is included in compilation as MBEDTLS_CONFIG_H is not defined anywhere
// Below include file will define entropy source : MBEDTLS_ENTROPY_HARDWARE_ALT :
// as TI SimpleLink Devices have a HW device TRNG
 ...
 */
#if !defined(MBEDTLS_ENTROPY_HARDWARE_ALT) && !defined(MBEDTLS_TEST_NULL_ENTROPY) && !defined(MBEDTLS_ENTROPY_NV_SEED)   // no entropy source defined
...
#endif
// KV: Not expected to come here
#else   // ENTROPY Source is defined
// KV: Compiling should come here
...
#if defined(MBEDTLS_SSL_TLS_C) && !defined(MBEDTLS_TEST_NULL_ENTROPY) && !defined(MBEDTLS_ENTROPY_HARDWARE_ALT) && !defined(MBEDTLS_ENTROPY_NV_SEED)
