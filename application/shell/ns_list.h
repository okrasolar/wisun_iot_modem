...
#define NS_LIST_LINK_INIT(name) \
    NS_FUNNY_INTPTR_OK{ NS_LIST_POISON, NS_LIST_POISON } NS_FUNNY_INTPTR_RESTORE
 ...
 * in simpler cases.
 */
#define NS_LIST_INIT(name)                  \
    {                                       \
        {                                   \
            NULL, &(name).slist.first_entry \
        }                                   \
    }
...
#define NS_LIST_DEFINE(name, type, field) \
    NS_LIST_HEAD(type, field)             \
    NS_LIST_NAME_INIT(name)
